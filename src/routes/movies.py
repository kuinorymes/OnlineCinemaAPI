...
from schemas import MovieListResponseSchema, MovieListItemSchema, MovieDetailSchema, MovieCreateSchema, MovieUpdateSchema
from database import get_db, MovieModel, GenreModel, StarModel, DirectorModel, CertificationModel
...
async def create_movie(
    ...
    if exists_movie:
        raise HTTPException(status_code=409, detail=f"A movie with name {movie_data.name} and year {movie_data.year} already exists")
